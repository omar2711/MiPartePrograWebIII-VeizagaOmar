...
builder.Services.AddDbContext<IntegradorContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("IntegradorContext") ?? throw new InvalidOperationException("Connection string 'IntegradorContext' not found.")));
